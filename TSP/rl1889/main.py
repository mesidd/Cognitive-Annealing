...
def plot_tour(final_tour, title):
    ...
    ax.plot(x_coords, y_coords, 'o-', markersize=2, linewidth=0.5)
    
    # Annotate city IDs (commented out for large tours to avoid clutter)
    # for city in final_tour.tour:
    #     ax.text(city.x, city.y, str(city.id), fontsize=6, ha='right')
...
if __name__ == "__main__":
    ...
    known_optimum = 316536
    accuracy_goal_percentage = .95 # 95% of optimal
