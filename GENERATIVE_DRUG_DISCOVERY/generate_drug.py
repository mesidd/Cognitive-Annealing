...
def get_starting_fragment(target_smiles):
    ...
    print("\n1. Decomposing target molecule to find a smart starting point...")
...
if __name__ == "__main__":
    ...
    if best_molecule_score > 0.7: print("\n*** Invented a novel and highly similar molecule. ***")
    elif best_molecule_score > 0.5: print("\n*** Discovered a promising molecular scaffold. ***")
    ...
    img.save('drug_discovery_result.png'); 
    
    print("...Final comparison image saved to 'drug_discovery_result.png \n")
